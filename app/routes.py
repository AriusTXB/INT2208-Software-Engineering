...
from app.controllers import (
    ...
    premium_article_controller, premium_subsciption_controller,
    read_news_controller, recommendations_controller,
    registration_controller, statistic_controller
)
...
router.include_router(premium_subsciption_controller.router, prefix="/subscription")
...
router.include_router(registration_controller.router, prefix="/auth")
